...
This React sample is provided with [Docker](https://github.com/app-generator/deploypro-react/blob/main/Dockerfile) support, the only input expected by DeployPRO service. 
...
This setup can be tested in a local workstation by cloning the [sources](https://github.com/app-generator/deploypro-react) from GitHub and type:
